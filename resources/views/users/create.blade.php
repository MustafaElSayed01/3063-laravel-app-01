...
<body class="bg-gray-50 min-h-screen flex items-center justify-center py-10">
    <form id="addUserForm" class="w-full max-w-lg bg-white rounded-2xl shadow-md p-8 space-y-6" novalidate>
        <!-- adjust action as needed -->
        <h1 class="text-2xl font-semibold text-gray-900 text-center">Add User</h1>
